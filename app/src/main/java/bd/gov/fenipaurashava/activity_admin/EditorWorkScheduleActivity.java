...
public class EditorWorkScheduleActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menu_delete:
                AlertDialog.Builder dialog = new AlertDialog.Builder(EditorWorkScheduleActivity.this);
    ...
    private void postData(final String key) {
        ...
        if (name.isEmpty()) {
            ...
            if (use_id ==12){
                final ProgressDialog mDialog = new ProgressDialog(EditorWorkScheduleActivity.this);
                ...
                call.enqueue(new Callback<AppointmentSubjectSaveResponse>() {
                    ...
                    public void onResponse(Call<AppointmentSubjectSaveResponse> call, Response<AppointmentSubjectSaveResponse> response) {
                        if (response.code() == 200) {
                            ...
                            Toast.makeText(EditorWorkScheduleActivity.this, "" + serverResponse.getMessage(), Toast.LENGTH_SHORT).show();

                            mDialog.dismiss();
                        } else if (response.code() == 203) {
                            Toast.makeText(EditorWorkScheduleActivity.this, "Fail", Toast.LENGTH_SHORT).show();
                            mDialog.dismiss();
                        } else if (response.code() == 401) {
                            Toast.makeText(EditorWorkScheduleActivity.this, "Unauthorized Access", Toast.LENGTH_SHORT).show();
                            mDialog.dismiss();
                        } else if (response.code() == 422) {
                            Toast.makeText(EditorWorkScheduleActivity.this, "Validation Error", Toast.LENGTH_SHORT).show();
                            mDialog.dismiss();
                        }
        ...
        if (use_id==Common.ADMIN_USER_ID){
            ...
            call.enqueue(new Callback<AppointmentSubjectUpdateResponse>() {
                ...
                public void onResponse(Call<AppointmentSubjectUpdateResponse> call, Response<AppointmentSubjectUpdateResponse> response) {
                    ...
                    Log.i(EditorWorkScheduleActivity.class.getSimpleName(), response.toString());

                    if (response.code()==200){
                        Toast.makeText(EditorWorkScheduleActivity.this, ""+response.body().getMessage(), Toast.LENGTH_SHORT).show();
                        progressDialog.dismiss();
                    }
                }
                ...
                public void onFailure(Call<AppointmentSubjectUpdateResponse> call, Throwable t) {
                    progressDialog.dismiss();
                    Toast.makeText(EditorWorkScheduleActivity.this, t.getMessage().toString(), Toast.LENGTH_SHORT).show();
                }
            });
            ...
            apiService.setAppointmentSubjectDeleteResponse(Common.APP_KEY, id, user_id).enqueue(new Callback<AppointmentSubjectDeleteResponse>() {
                ...
                public void onResponse(Call<AppointmentSubjectDeleteResponse> call, Response<AppointmentSubjectDeleteResponse> response) {
                    ...
                    if (response.code() == 200) {
                        ...
                        Toast.makeText(EditorWorkScheduleActivity.this, "problem", Toast.LENGTH_SHORT).show();
                    }
                ...
                public void onFailure(Call<AppointmentSubjectDeleteResponse> call, Throwable t) {
                    ...
                    Toast.makeText(EditorWorkScheduleActivity.this, ""+t.getMessage(), Toast.LENGTH_SHORT).show();
                    progressDialog.dismiss();
                }
            });
