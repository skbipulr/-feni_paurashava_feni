...
import bd.gov.fenipaurashava.departmentAdmin.adapter.DepartmentAdminListAdapter;
import bd.gov.fenipaurashava.departmentUser.model.Department;
import bd.gov.fenipaurashava.departmentUser.model.DepartmentListResponse;
...
public class DepartmentAdminListActivity extends AppCompatActivity {

    private RecyclerView departmentRV;
    private DepartmentAdminListAdapter departmentListAdapter;
        ...
        apiService.getEmployeeResponse(Common.APP_KEY).enqueue(new Callback<EmployeeResponse>() {
            ...
            public void onResponse(Call<EmployeeResponse> call, Response<EmployeeResponse> response) {
                if (response.code() == 200) {
                    ...
                    Toast.makeText(DepartmentAdminListActivity.this, "server problem", Toast.LENGTH_SHORT).show();
                    swipeRefreshLayout.setRefreshing(false);
                }
            }
    ...
    private void initDepartment() {
        ...
        departmentListAdapter = new DepartmentAdminListAdapter(DepartmentAdminListActivity.this, departmentList);
